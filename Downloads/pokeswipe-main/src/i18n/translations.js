export const SUPPORTED = ['zh-TW', 'en', 'ja', 'es', 'pt']
...
export const dict = {
  'zh-TW': {
    ...
    'config.notice':       '⚙️ 設定 VITE_CLOUDINARY_CLOUD_NAME 環境變數以啟用跨裝置分享。目前為本機模式（僅你的瀏覽器可見）。',
    'aria.view':           '查看好友碼 QR',
    'aria.next':           '下一個',
    'aria.skip':           '跳過（← 鍵）',
    'aria.add':            '加好友（→ 鍵）',
  ...
  en: {
    ...
    'config.notice':       '⚙️ Set VITE_CLOUDINARY_CLOUD_NAME env var to enable cross-device sharing. Currently in local mode (your browser only).',
  ...
  ja: {
    ...
    'config.notice':       '⚙️ VITE_CLOUDINARY_CLOUD_NAME 環境変数を設定してください。現在はローカルモードです。',
  ...
  es: {
    ...
    'config.notice':       '⚙️ Configura VITE_CLOUDINARY_CLOUD_NAME para compartir con todos. Modo local activo.',
    ...
    'verify.notFound':     'No se encontró código. Sube la pantalla de código de entrenador 📸',
    ...
    'help.s1.body':        'Explora capturas de códigos de amigo compartidas por otros jugadores.<br><strong>📱 Móvil:</strong> Toca "Copiar Código", luego abre Pokémon GO → Amigos → Agregar amigo.<br><strong>💻 PC:</strong> Usa ← → para navegar, Space para ampliar, C para copiar.',
    'help.s2.title':       'Subir captura',
    'help.s2.body':        'Abre Pokémon GO y ve a tu Tarjeta de Entrenador (la pantalla con tu código QR). Toma una captura vertical y súbela aquí.',
  ...
  pt: {
    ...
    'config.notice':       '⚙️ Configure VITE_CLOUDINARY_CLOUD_NAME para compartilhar com todos. Modo local ativo.',
    ...
    'verify.notFound':     'Código não encontrado. Envie um print da tela de código de treinador 📸',
    ...
    'help.s1.body':        'Explore prints de códigos de amigo compartilhados por outros jogadores.<br><strong>📱 Celular:</strong> Toque em "Copiar Código", depois abra Pokémon GO → Amigos → Adicionar amigo.<br><strong>💻 PC:</strong> Use ← → para navegar, Space para ampliar, C para copiar.',
    'help.s2.title':       'Enviar print',
    'help.s2.body':        'Abra o Pokémon GO e acesse seu Cartão de Treinador (a tela com seu QR Code). Tire um print na vertical e envie aqui.',
