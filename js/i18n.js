...
const I18n = (() => {
  ...
  const dict = {
    ...
    'zh-TW': {
      ...
      'help.s1.icon':        '🔄',
      'help.s1.title':       '滑動加友',
      'help.s1.body':        '瀏覽其他玩家分享的好友碼截圖。<br>👆 點圖片 → 放大查看好友碼<br>➡️ 點「下一個」→ 跳過這張<br>記下好友碼後，在 Pokémon GO → 好友 → 新增好友',
      'help.s2.icon':        '📤',
      'help.s2.title':       '上傳截圖',
      'help.s2.body':        '分享你的好友碼給全世界！<br>① 打開 Pokémon GO<br>② 點頭像 → 訓練家名片（有 QR Code 的頁面）<br>③ 截圖（直向）<br>④ 回來上傳',
      'help.s3.icon':        '🔒',
    ...
    'en': {
      ...
      'help.s1.body':        'Browse friend code screenshots shared by other players.<br>👆 Tap the card → zoom in to read the code<br>➡️ Tap "Next" → skip to the next one<br>Note the code, then add them in Pokémon GO → Friends → Add Friend',
      'help.s2.icon':        '📤',
      'help.s2.title':       'Upload Screenshot',
      'help.s2.body':        'Share your friend code with the world!<br>① Open Pokémon GO<br>② Tap your avatar → Trainer Card (the page with your QR Code)<br>③ Take a portrait screenshot<br>④ Come back here and upload it',
      'help.s3.icon':        '🔒',
      'help.s3.title':       'Free & No Account Needed',
      'help.s3.body':        'Uses an anonymous device ID only — no personal data collected. Max 5 uploads per day.',
    },
    ...
    'ja': {
      ...
      'help.s1.body':        '他のプレイヤーが共有したフレンドコードを見てみよう。<br>👆 カードをタップ → コードを拡大確認<br>➡️「次へ」をタップ → 次のカードへ<br>コードをメモして、ポケモンGO → フレンド → フレンドを追加',
      'help.s2.icon':        '📤',
      'help.s2.title':       'スクショを投稿する',
      'help.s2.body':        '自分のフレンドコードをシェアしよう！<br>① ポケモンGOを開く<br>② アイコンをタップ → トレーナーカード（QRコードがある画面）<br>③ 縦向きでスクリーンショット<br>④ ここに戻って投稿',
      'help.s3.icon':        '🔒',
    ...
    'es': {
      ...
      'help.s1.body':        'Explora capturas de códigos de amigo compartidas por otros jugadores.<br>👆 Toca la tarjeta → ampliar para leer el código<br>➡️ Toca "Siguiente" → pasar a la próxima<br>Anota el código y agrégalo en Pokémon GO → Amigos → Agregar amigo',
      'help.s2.icon':        '📤',
      'help.s2.title':       'Subir captura',
      'help.s2.body':        '¡Comparte tu código de amigo con el mundo!<br>① Abre Pokémon GO<br>② Toca tu avatar → Tarjeta de Entrenador (la pantalla con tu QR)<br>③ Toma una captura vertical<br>④ Vuelve aquí y súbela',
      'help.s3.icon':        '🔒',
    ...
    'pt': {
      ...
      'help.s1.body':        'Explore prints de códigos de amigo compartilhados por outros jogadores.<br>👆 Toque no card → ampliar para ler o código<br>➡️ Toque em "Próximo" → ir para o próximo<br>Anote o código e adicione no Pokémon GO → Amigos → Adicionar amigo',
      'help.s2.icon':        '📤',
      'help.s2.title':       'Enviar print',
      'help.s2.body':        'Compartilhe seu código de amigo com o mundo!<br>① Abra o Pokémon GO<br>② Toque no seu avatar → Cartão de Treinador (a tela com seu QR Code)<br>③ Tire um print na vertical<br>④ Volte aqui e envie',
      'help.s3.icon':        '🔒',
