...
const I18n = (() => {
  ...
  const dict = {
    ...
    'zh-TW': {
      ...
      'config.notice':    '⚙️ 請打開 <code>assets/js/services/cloudinary.js</code> 填入 <strong>CLOUD_NAME</strong> 和 <strong>UPLOAD_PRESET</strong>，才能讓所有人共用同一張圖庫。目前為本機模式（僅你的瀏覽器可見）。',
      'aria.view':        '查看好友碼 QR',
      'aria.next':        '下一個',
      'aria.skip':        '跳過（← 鍵）',
      'aria.add':         '加好友（→ 鍵）',
      ...
      'copy.noCode':         '點擊查看好友碼',
      'copy.noCodeToast':    '此截圖未偵測到好友碼，點擊卡片可手動查看',
      'kbd.copy':            '複製',
      'help.s1.title':       '滑動加友',
    ...
    'en': {
      ...
      'config.notice':    '⚙️ Open <code>assets/js/services/cloudinary.js</code> and fill in <strong>CLOUD_NAME</strong> and <strong>UPLOAD_PRESET</strong> to share images with everyone. Currently in local mode (your browser only).',
      ...
      'copy.noCodeToast':    'No friend code detected — tap the card to view manually',
      'kbd.copy':            'Copy',
    ...
    'ja': {
      ...
      'config.notice':    '⚙️ <code>assets/js/services/cloudinary.js</code> を開いて <strong>CLOUD_NAME</strong> と <strong>UPLOAD_PRESET</strong> を設定してください。現在はローカルモードです（このブラウザのみ）。',
      ...
      'copy.noCode':         'タップして確認',
      'copy.noCodeToast':    'フレンドコードが検出されませんでした。カードをタップして確認してください',
      'kbd.copy':            'コピー',
    ...
    'es': {
      ...
      'config.notice':    '⚙️ Abre <code>assets/js/services/cloudinary.js</code> y completa <strong>CLOUD_NAME</strong> y <strong>UPLOAD_PRESET</strong> para compartir con todos. Modo local activo (solo este navegador).',
      ...
      'copy.noCodeToast':    'No se detectó código de amigo — toca la tarjeta para verla',
      'kbd.copy':            'Copiar',
    ...
    'pt': {
      ...
      'config.notice':    '⚙️ Abra <code>assets/js/services/cloudinary.js</code> e preencha <strong>CLOUD_NAME</strong> e <strong>UPLOAD_PRESET</strong> para compartilhar com todos. Modo local ativo (apenas este navegador).',
      ...
      'copy.noCodeToast':    'Código de amigo não detectado — toque no cartão para ver',
      'kbd.copy':            'Copiar',
